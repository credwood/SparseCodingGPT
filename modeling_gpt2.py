...
# Adapted from: https://github.com/huggingface/transformers/blob/v4.31.0/src/transformers/models/gpt2/modeling_gpt2.py#L748
...
class GPT2Block(nn.Module):
    def __init__(self, config, layer_idx=None):
        ...
        self.hook_mid_residual = HookPoint()
...
class GPT2Model(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        # name and cache hooks present in model
    ...
    def set_use_hook_cache(self, use_hook_cache):
