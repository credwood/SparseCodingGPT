...
if __name__ == '__main__':
    ...
    parser.add_argument('--example_dir', type=str, default='./top_activated_examples/example_l_1.npy', help='The path of the top activated examples from a given layer for a given hook')
